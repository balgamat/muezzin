...
| `params?`       | Request params. _See [Fetch](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch)_                                                                                                                                                                         | _RequestInit_                                                                                  | `{ headers: defaultHeaders, method: 'GET' }` | `{ method: 'POST', body: JSON.stringify({data: 'DATA'}) }` |
